...
class Form {
	...
	public static function open($action = NULL, array $attributes = NULL)
	{
		...
		$attributes['accept-charset'] = "utf-8"; /*"Kohana::$charset"*/
	...
	/*	$attributes['value'] = $value;*/
		...
		return '<input value="'. esc_attr( $value ) .'"'.HTML::attributes($attributes).' />';
	}
	...
	/**
	 * Creates a form color.
	 *
	 *     echo Form::color('field_name', '#ffffff');
	 *
	...
	public static function color($name, $value =NULL, array $attributes = NULL) {
		...
		<input  id="<?php echo $id; ?>"  type="input" name="<?php echo  $name; ?>"  class="input-<?php echo $id; ?> dinamic-css color-field" value="<?php echo  $value ?>" style="float:left; margin-right:2px; width:75px;" <?php echo  HTML::attributes($attributes) ?> onchange="javascript:document.getElementById('<?php echo  'color'.$id; ?>').value = document.getElementById('<?php echo $id; ?>').value;"/>	
		
		
		<?php $colorr =  ($value == 'transparent' ) ? "#ffffff" : ( ( $value == '' ) ? '#ffffff' : $value ); ?>
		
		
		<input id="color<?php echo $id; ?>" type="color" name="color<?php echo  $name; ?>"  class="input-<?php echo $id; ?> dinamic-css color-field" value="<?php echo  $colorr ?>" style="float:left; margin-right:2px; height:30px;" onchange="javascript:document.getElementById('<?php echo  $id; ?>').value = document.getElementById('<?php echo  'color'.$id; ?>').value;"/>	
