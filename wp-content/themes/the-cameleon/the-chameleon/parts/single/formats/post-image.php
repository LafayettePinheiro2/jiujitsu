<?php
	...
	<section class="col100 post-content post-content-single">
			...
			<?php if ( TheChameleon_has_post_media( $post->ID ) or has_post_thumbnail() ) : ?>	
				...
				<figure class="post-media post-media-standard post-media-single post-media-standard-single aligncenter">				

						<?php echo TheChameleon_get_post_featured_media(  $post->ID, 'image', array() ); ?>
